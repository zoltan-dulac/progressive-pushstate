...
// pakmanager:progressive-pushstate/js/progressive-pushstate.js
(function (context) {
  ...
  'use strict';
    ...
    var pp = new function () {
    	...
    	me.lastState = {};
    	me.popstateEvent = function (e, state) {}; // eslint-disable-line no-unused-vars
    	me.options = {};
    	 ...
    	 */
    	me.objectToQueryString = function(obj) {
    		var i, j, sb = [],
    ...
    module && (module.exports = pp);
  provide("progressive-pushstate/js/progressive-pushstate.js", module.exports);
}(global));

// pakmanager:progressive-pushstate
(function (context) {
  ...
  'use strict';
    ...
    module.exports =  require('progressive-pushstate/js/progressive-pushstate.js');
    
  provide("progressive-pushstate", module.exports);
}(global));